...
python inference_centrality.py --dataset "Cora" --centrality "DEGREE" --num_clusters 5 
```
...
cd ./ADMPGNN/
python main.py --dataset "Cora" 
python inference_centrality.py --dataset "Cora" --centrality "KCORE" --num_clusters 5 
```
...
cd ./ADMPGNN/
python main.py --dataset "Cora" 
python inference_centrality.py --dataset "Cora" --centrality "PAGERANK" --num_clusters 5 
```
...
cd ./ADMPGNN/
python main.py --dataset "Cora" 
python inference_centrality.py --dataset "Cora" --centrality "DEPTH" --num_clusters 5 
```